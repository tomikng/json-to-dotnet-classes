...
class TestCSharpClassGenerator(unittest.TestCase):
    ...
    def test_pascal_case_conversion(self):
        ...
        self.assertEqual(generator.to_pascal_case("API_KEY"), "ApiKey")  # Snake_case conversion
        self.assertEqual(generator.to_pascal_case("simple"), "Simple")
        
    def test_preserved_naming_conventions(self):
        """Test that naming conventions preserve original structure."""
        generator = CSharpClassGenerator(self.test_json_file, self.output_dir)
        
        # Preserve suffixes and prefixes
        self.assertEqual(generator.get_class_name_from_context("StatusDD"), "StatusDD")
        self.assertEqual(generator.get_class_name_from_context("TypeDD"), "TypeDD")
        
        # Preserve prefixes
        self.assertEqual(generator.get_class_name_from_context("strStatus"), "StrStatus")
        self.assertEqual(generator.get_class_name_from_context("strUserName"), "StrUserName")
        
        # Preserve technical suffixes
        self.assertEqual(generator.get_class_name_from_context("FxLinkResponseID"), "FxLinkResponseID")
        self.assertEqual(generator.get_class_name_from_context("CombinedGDS"), "CombinedGDS")
        self.assertEqual(generator.get_class_name_from_context("CombinedTDS"), "CombinedTDS")
        
        # Preserve numbers to prevent duplicates
        self.assertEqual(generator.to_pascal_case("Level1Split"), "Level1Split")
        self.assertEqual(generator.to_pascal_case("Level2Split"), "Level2Split")
        self.assertEqual(generator.to_pascal_case("level1Split"), "Level1Split")
        self.assertEqual(generator.to_pascal_case("level2Split"), "Level2Split")
    ...
    def test_simple_object_generation(self):
        ...
        # Check auto-generated comment and nullable directive
        ...
        self.assertIn("#nullable enable", content)
